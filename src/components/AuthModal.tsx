    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="relative w-full max-w-2xl max-h-[85vh] bg-background/95 backdrop-blur-sm rounded-lg shadow-2xl border border-border/50 flex flex-col overflow-hidden">
              {/* Close Button */}
              <motion.button
